...
به طور خاص، فصل ۴ سه ستون اصلی را معرفی می‌کند که زبان JavaScript حول آن‌ها سازماندهی شده است: scope/closures، prototypes/objects و types/coercion. 
 جاوااکریپت یک زبان گسترده و پیچیده است، با ویژگی‌ها و قابلیت‌های فراوان. اما تمام JavaScript بر روی این سه ستون بنیادی استوار است.
